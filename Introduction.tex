...
\footnotetext{The interactions here do not include the gravitation. In the following text, ''the interactions in the SM`` will simply refer to the electromagnetic, weak, and strong interactions. }
...
\subsection{The measurement of the Higgs couplings}
